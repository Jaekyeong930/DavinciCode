...
background = pygame.image.load('C:/AutoSet10/public_html/python/myproject/FinalExam/월넛.jpg') # 배경 이미지
...
color_black = pygame.image.load('C:/AutoSet10/public_html/python/myproject/FinalExam/blackCard.png') #카드 색 : 블랙
color_white = pygame.image.load('C:/AutoSet10/public_html/python/myproject/FinalExam/whiteCard.png') #카드 색 : 화이트
